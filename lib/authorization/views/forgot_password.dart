            ...
            child:  Column(
              ...
              children: [
                const Padding(
                  ...
                  child: Text('Reset Password',style: TextStyle(color: Colors.black,fontFamily: 'outfit' ,fontSize: 20,fontWeight: FontWeight.w600),),
                ),
                ...
                const AppTextFormField(hintText: 'Email or mobile number',showLabel: false,),
                 ...
                 const Padding(
                   ...
                   child: Text('OTP and verification link will be sent to your registered email/number to reset password.',style: TextStyle(color: Color(0xff505050),fontFamily: 'outfit' ,fontSize: 12,fontWeight: FontWeight.w400),)
                 ),
