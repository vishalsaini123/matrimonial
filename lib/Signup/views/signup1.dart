              ...
              child: Column(
                children: [
                   ...
                   Padding(
                    ...
                    child: CustomPageIndicator(currentPage: controller.profilepageprogress.value,pageCount: 9,),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: PageView(
                      ...
                      onPageChanged: (num){
                        controller.profilepageprogress.value = num;

                      },
                      children: [
                        profile1(),
                        const AppRadioButtonsFormField(text: "Select your gender",),
                        dob(),
                        uploadPhotos(),
                        nativePlace(),
                        highestEducation(),
  ...
  Widget nativePlace(){
    return const Column(
      ...
      children: [
        Padding(
          padding: EdgeInsets.all(8.0),
          child: Text('What is your native place?',style: TextStyle(color: Colors.black,fontFamily: 'outfit' ,fontSize: 20,fontWeight: FontWeight.w600),),
        ),
        SizedBox(height: 10,),
  ...
  Widget religiousBelieve(){
    return  Column(
      ...
      children: [
        const Padding(
          padding: EdgeInsets.all(8.0),
          child: Text('Select your religious believe',style: TextStyle(color: Colors.black,fontFamily: 'outfit' ,fontSize: 20,fontWeight: FontWeight.w600),),
        ),
        const SizedBox(height: 10,),
       Expanded(
